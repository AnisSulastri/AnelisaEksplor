...
class Jelajahpesan extends StatefulWidget {
  final Jelajahlist destination; // Menerima TravelDestination sebagai parameter

  // Constructor menerima destination
  Jelajahpesan({required this.destination});

  @override
  _JelajahpesanState createState() => _JelajahpesanState();
}

class _JelajahpesanState extends State<Jelajahpesan> {
