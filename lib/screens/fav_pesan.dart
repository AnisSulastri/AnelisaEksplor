...
class FavPesan extends StatefulWidget {
  final FavModel destination; // Menerima TravelDestination sebagai parameter

  // Constructor menerima destination
  FavPesan({required this.destination});

  @override
  _FavPesanState createState() => _FavPesanState();
}

class _FavPesanState extends State<FavPesan> {
